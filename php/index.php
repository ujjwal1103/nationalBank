...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #82E0AA;">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="Images/bank.webp" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="Images/user.webp" class="img-fluid">
                    <br>
                  ...
                  <div class="col-md act">
                    <img src="Images/2534227.png" class="img-fluid">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Ujjwal Lade</b> <br>National Bank</p>
      </footer>
